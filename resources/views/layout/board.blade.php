<section id="sectionBoard">
    <a href=""><img src="img/back.svg" alt="précédent" class="buttonArrowBoard" id="backBoard"></a> 
    <img src="img/plancheBD.JPG" alt="planche de BD" class="boardsBD">
    <a href=""><img src="/img/next.svg" alt="suivant" class="buttonArrowBoard" id="nextBoard"></a> 
</section>
